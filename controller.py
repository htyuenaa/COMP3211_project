...
from search import a_star_search_with_conditions
...
class State:
    ...
    def __init__(self, init_pos, goal, conditions=None):
    ...
    def run_search(self, layout):
        ...
        for name in State.agents_name:
            path = a_star_search_with_conditions(
                layout, self.initial_positions[name], self.goals[name], conditions=self.conditions[name])
    ...
    def get_new_states(self, condition1, condition2):
        state1 = State(self.initial_positions, self.goals, self.conditions)
        ...
        state2 = State(self.initial_positions, self.goals, self.conditions)
